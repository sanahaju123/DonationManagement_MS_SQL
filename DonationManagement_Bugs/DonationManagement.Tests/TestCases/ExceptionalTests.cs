...
using DonationManagement.BusinessLayer.Services;
...
using DonationManagement.TestCases;
using Moq;
using System;
...
namespace DonationManagement.Tests.TestCases
{
    public class ExceptionalTests
    {
        ...
        /// <returns></returns>
        [Fact]
        public async Task<bool> Testfor_Validate_DonationAmountIsValidOrNot()
        {
            //Arrange
            bool res = false;
            string testName; string status;
        ...
        /// <returns></returns>
        [Fact]
        public async Task<bool> Testfor_Validate_DonorId_IsvalidorNot()
        {
            //Arrange
            bool res = false;
            string testName; string status;
